                    ...
                    <div class="col-md-12">
                        ...
                        <div class='form-group clearfix'>
                          {{ Form::label("desc", "Deskripsi", ['class' => 'col-md-12 control-label']) }}
                            <div class='col-md-12'>
                              <textarea type="text" name="desc" value="" class="form-control article-ckeditor" required="required", placeholder= "Masukan Deskripsi" rows="4">{{{$slider->desc}}}</textarea>
                            </div>
                        </div>
                       ...
                       <div class='form-group clearfix'>
                          {{ Form::label("img", "Images", ['class' => 'col-md-12 control-label']) }}
                            ...
                            <img src="{{ asset('/images/sliders/'.$slider->img)}}" style="max-height:100px;max-width:100px;margin-top:10px;">
                            </div>
                        </div>
