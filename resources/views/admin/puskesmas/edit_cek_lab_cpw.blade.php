      ...
      <div class="element-wrapper">
        ...
        <div class="element-box col-md-12">
            <section class="content">
              <div class="row">
                <div class="col-md-12">
                {!! Form::model($catin,['method'=>'put', 'files'=> 'true', 'action'=>['admin\PuskesmasController@updateLab',$catin->biodataCpw->cekLabCPW->id]]) !!}
                <div class="row">
                  <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group clearfix{{ $errors->has('pemeriksa') ? ' has-error' : '' }}">
                        {{ Form::label("pemeriksa", "Pemeriksa *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="pemeriksa" value="{{ $catin->biodataCpw->cekLabCPW->pemeriksa }}" class="form-control" required="required", placeholder= "-">
                          </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group clearfix{{ $errors->has('dokter') ? ' has-error' : '' }}">
                        {{ Form::label("dokter", "Dokter *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="dokter" value="{{ $catin->biodataCpw->cekLabCPW->dokter }}" class="form-control" required="required", placeholder= "-">
                          </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group clearfix{{ $errors->has('hgb_hb') ? ' has-error' : '' }}">
                        {{ Form::label("hgb_hb", "HGB / HB *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="hgb_hb" value="{{ $catin->biodataCpw->cekLabCPW->hgb_hb }}" class="form-control" required="required", placeholder= "-">
                          </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('goldar') ? ' has-error' : '' }}">
                        {{ Form::label("goldar", "GOL DAR *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="goldar" value="{{ $catin->biodataCpw->cekLabCPW->goldar }}" class="form-control" required="required", placeholder= "-">
                          </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('syphilis') ? ' has-error' : '' }}">
                        {{ Form::label("syphilis", "SYPHILIS *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                            {{ Form::select('syphilis', $syphilis, $catin->biodataCpw->cekLabCPW->syphilis,['class' => 'form-control' , 'required' ,'placeholder' => 'Pilih Hasil']) }}
                          </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group clearfix{{ $errors->has('glukosa') ? ' has-error' : '' }}">
                        {{ Form::label("glukosa", "GLUKOSA *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                         {{ Form::select('glukosa', $glukosa, $catin->biodataCpw->cekLabCPW->glukosa,['class' => 'form-control' , 'required' ,'placeholder' => 'Pilih Hasil']) }}
                    ...
                    <div class="form-group clearfix{{ $errors->has('hbsag') ? ' has-error' : '' }}">
                        {{ Form::label("hbsag", "HBsAG *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                         {{ Form::select('hbsag', $hbsag, $catin->biodataCpw->cekLabCPW->hbsag,['class' => 'form-control' , 'required' ,'placeholder' => 'Pilih Hasil']) }}
                          </div>
                          @if ($errors->has('hbsag'))
                              <span class="help-block">
                    ...
                    <div class="form-group clearfix{{ $errors->has('hiv_aids') ? ' has-error' : '' }}">
                        {{ Form::label("hiv_aids", "HIV / AIDS *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          {{ Form::select('hiv_aids', $hiv_aids, $catin->biodataCpw->cekLabCPW->hiv_aids,['class' => 'form-control' , 'required' ,'placeholder' => 'Pilih Hasil']) }}
                          </div>
