      ...
      <div class="element-wrapper">
        ...
        <div class="element-box col-md-12">
            <section class="content">
              <div class="row">
                <div class="col-md-12">
                {!! Form::model($catin,['method'=>'put', 'files'=> 'true', 'action'=>['admin\PuskesmasController@updateLab',$catin->biodataCpp->cekLabCPP->id]]) !!}
                <div class="row">
                  <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group clearfix{{ $errors->has('biodata_id') ? ' has-error' : '' }}" style="display: none;">
                        {{ Form::label("biodata_id", "Nama *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="biodata_id" value="{{ $catin->biodataCpp->id }}" class="form-control" required="required", placeholder= "-">
                          </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('judul') ? ' has-error' : '' }}">
                        {{ Form::label("title", "Nama *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" value="{{ $catin->biodataCpp->nama_lengkap }}" class="form-control" required="required", placeholder= "-" disabled>
                          </div>
                          @if ($errors->has('judul'))
                              <span class="help-block">
                    ...
                    <div class="form-group clearfix{{ $errors->has('judul') ? ' has-error' : '' }}">
                        {{ Form::label("title", "Umur *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" value="{{ $age_cpp }}" class="form-control" required="required", placeholder= "-" disabled>
                          </div>
                          @if ($errors->has('judul'))
                              <span class="help-block">
                                  <strong>{{ $errors->first('judul') }}</strong>
                    ...
                    <div class="form-group clearfix{{ $errors->has('pemeriksa') ? ' has-error' : '' }}">
                        {{ Form::label("pemeriksa", "Pemeriksa *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="pemeriksa" value="{{ $catin->biodataCpp->cekLabCPP->pemeriksa }}" class="form-control" required="required", placeholder= "-">
                          </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group clearfix{{ $errors->has('judul') ? ' has-error' : '' }}">
                        {{ Form::label("title", "Alamat *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" value="{{ $catin->biodataCpp->tempat_tinggal }}" class="form-control" required="required", placeholder= "-" disabled>
                          </div>
                          @if ($errors->has('judul'))
                              <span class="help-block">
                                  <strong>{{ $errors->first('judul') }}</strong>
                    ...
                    <div class="form-group clearfix{{ $errors->has('dokter') ? ' has-error' : '' }}">
                        {{ Form::label("dokter", "Dokter *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="dokter" value="{{ $catin->biodataCpp->cekLabCPP->dokter }}" class="form-control" required="required", placeholder= "-">
                          </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group clearfix{{ $errors->has('hgb_hb') ? ' has-error' : '' }}">
                        {{ Form::label("hgb_hb", "HGB / HB *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="hgb_hb" value="{{ $catin->biodataCpp->cekLabCPP->hgb_hb }}" class="form-control" required="required", placeholder= "-">
                          </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('goldar') ? ' has-error' : '' }}">
                        {{ Form::label("goldar", "GOL DAR *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="goldar" value="{{ $catin->biodataCpp->cekLabCPP->goldar }}" class="form-control" required="required", placeholder= "-">
                          </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('syphilis') ? ' has-error' : '' }}">
                        {{ Form::label("syphilis", "SYPHILIS *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                            {{ Form::select('syphilis', $syphilis, $catin->biodataCpp->cekLabCPP->syphilis,['class' => 'form-control' , 'required' ,'placeholder' => 'Pilih Hasil']) }}
                          </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group clearfix{{ $errors->has('glukosa') ? ' has-error' : '' }}">
                        {{ Form::label("glukosa", "GLUKOSA *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                         {{ Form::select('glukosa', $glukosa, $catin->biodataCpp->cekLabCPP->glukosa,['class' => 'form-control' , 'required' ,'placeholder' => 'Pilih Hasil']) }}
                    ...
                    <div class="form-group clearfix{{ $errors->has('hbsag') ? ' has-error' : '' }}">
                        {{ Form::label("hbsag", "HBsAG *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                         {{ Form::select('hbsag', $hbsag, $catin->biodataCpp->cekLabCPP->hbsag,['class' => 'form-control' , 'required' ,'placeholder' => 'Pilih Hasil']) }}
                          </div>
                          @if ($errors->has('hbsag'))
                              <span class="help-block">
                    ...
                    <div class="form-group clearfix{{ $errors->has('hiv_aids') ? ' has-error' : '' }}">
                        {{ Form::label("hiv_aids", "HIV / AIDS *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          {{ Form::select('hiv_aids', $hiv_aids, $catin->biodataCpp->cekLabCPP->hiv_aids,['class' => 'form-control' , 'required' ,'placeholder' => 'Pilih Hasil']) }}
                          </div>
