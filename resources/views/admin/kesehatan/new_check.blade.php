            ...
            <section class="content">
              <div class="row">
                <div class="col-md-12">
                    ...
                    {!! Form::model($catin,['files'=>true,'method'=>'post','action'=>['admin\KesehatanController@update',$catin->kesehatanCpp->id]]) !!}
                    <div class="form-group clearfix{{ $errors->has('name') ? ' has-error' : '' }}">
                        {{ Form::label("name", "Nama Pengantin", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" value="{{ $catin->biodataCpp->nama_lengkap }}" class="form-control" disabled>
                          <input style="display:none" name="biodata_id" type="text" value="{{ $catin->biodataCpp->id }}" class="form-control">
                          </div>
                    </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('name') ? ' has-error' : '' }}">
                        {{ Form::label("name", "Nama Dokter *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="name" value="{{ $catin->kesehatanCpp->name }}" class="form-control" required="required", placeholder= "Masukan Judul">
                          </div>
                          @if ($errors->has('name'))
                    ...
                    <div class="form-group clearfix{{ $errors->has('kecamatan') ? ' has-error' : '' }}">
                        {{ Form::label("kecamatan", "Kecamatan Dokter *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="kecamatan" value="{{ $catin->kesehatanCpp->kecamatan }}" class="form-control" required="required", placeholder= "Masukan Judul">
                          </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('kelurahan') ? ' has-error' : '' }}">
                        {{ Form::label("kelurahan", "Kelurahan Dokter *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="kelurahan" value="{{ $catin->kesehatanCpp->kelurahan }}" class="form-control" required="required", placeholder= "Masukan Judul">
                          </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('cek_narkoba') ? ' has-error' : '' }}">
                      {{ Form::label("cek_narkoba", "Cek Narkoba *", ['class' => 'col-md-12 control-label']) }}
                        <div class='col-md-12'>
                          {{ Form::select('cek_narkoba', $type, $catin->kesehatanCpp->cek_narkoba,['class' => 'form-control' , 'required','value'=>null ,'placeholder' => 'Menggunakan Narkoba?']) }}
                        </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('cek_cacat_badan') ? ' has-error' : '' }}">
                      {{ Form::label("cek_cacat_badan", "Cek Cacat Badan *", ['class' => 'col-md-12 control-label']) }}
                        <div class='col-md-12'>
                            {{ Form::select('cek_cacat_badan', $type, $catin->kesehatanCpp->cek_cacat_badan,['class' => 'form-control' , 'required','value'=>null ,'placeholder' => 'Menggunakan Narkoba?']) }}
                        </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('cek_buta_warna') ? ' has-error' : '' }}">
                      {{ Form::label("cek_buta_warna", "Cek Buta Warna *", ['class' => 'col-md-12 control-label']) }}
                        <div class='col-md-12'>
                            {{ Form::select('cek_buta_warna', $type, $catin->kesehatanCpp->cek_buta_warna,['class' => 'form-control' , 'required','value'=>null ,'placeholder' => 'Menggunakan Narkoba?']) }}
                        </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('td') ? ' has-error' : '' }}">
                        {{ Form::label("td", "Nilai TD *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="td" value="{{$catin->kesehatanCpp->td}}" class="form-control" required="required", placeholder= "Masukan Judul">
                          </div>
                          @if ($errors->has('td'))
                              <span class="help-block">
                    ...
                    <div class="form-group clearfix{{ $errors->has('tb') ? ' has-error' : '' }}">
                        {{ Form::label("tb", "Nilai TB *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="tb" value="{{ $catin->kesehatanCpp->tb }}" class="form-control" required="required", placeholder= "Masukan Judul">
                          </div>
                          @if ($errors->has('tb'))
                              <span class="help-block">
                    ...
                    <div class="form-group clearfix{{ $errors->has('bb') ? ' has-error' : '' }}">
                        {{ Form::label("bb", "Berat Badan *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="bb" value="{{ $catin->kesehatanCpp->bb }}" class="form-control" required="required", placeholder= "Masukan Judul">
                          </div>
                          @if ($errors->has('bb'))
                              <span class="help-block">
                    ...
                    <div class="form-group clearfix{{ $errors->has('goldar') ? ' has-error' : '' }}">
                      {{ Form::label("goldar", "Golongan Darah *", ['class' => 'col-md-12 control-label']) }}
                        <div class='col-md-12'>
                            {{ Form::select('goldar', $goldar, $catin->kesehatanCpp->goldar,['class' => 'form-control' , 'required','value'=>null ,'placeholder' => 'Menggunakan Narkoba?']) }}
                        </div>
                    ...
                    <div class="form-group clearfix{{ $errors->has('ket') ? ' has-error' : '' }}">
                        {{ Form::label("ket", "Deskripsi *", ['class' => 'col-md-4 control-label']) }}
                          <div class='col-md-12'>
                          <textarea type="text" id="ckeditor" name="ket" value="{{ $catin->kesehatanCpp->ket }}" class="form-control article-ckeditor" required="required", placeholder= "Masukan Deskripsi" rows="4">{{ $catin->kesehatanCpp->ket }}</textarea>
                          </div>
                          @if ($errors->has('ket'))
                              <span class="help-block">
