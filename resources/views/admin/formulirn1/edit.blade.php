    ...
    <div class="content-box">
      <div class="element-wrapper">
        ...
        <div class="col-md-12 text-center" style="margin: 15px;">
          <strong>Data Calon Pengantin Pria</strong>
        </div>
        ...
        {!! Form::model($biodatas,['method'=>'put', 'files'=> 'true', 'action'=>['admin\N1FormulirController@update',$biodatas->biodataCpp->n1Formulir->id]]) !!}
        <div class="element-box col-md-12">
            <section class="content">
              <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6" style="display:none">
                      <div class="form-group clearfix{{ $errors->has('catin_id') ? ' has-error' : '' }}">
                        {{ Form::label("catin_id", "Catin Id", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="catin_id" value="{{ $biodatas->biodataCpp->catin_id }}" class="form-control" required="required", placeholder= "">
                          </div>
                          @if ($errors->has('catin_id'))
                              <span class="help-block">
                                  <strong>{{ $errors->first('catin_id') }}</strong>
                              </span>
                          @endif
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('bin_binti') ? ' has-error' : '' }}">
                        {{ Form::label("bin_binti", "Bin/Binti",['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="bin_binti" value="{{ $biodatas->biodataCpp->n1Formulir->bin_binti }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('status_pernikahan') ? ' has-error' : '' }}">
                        {{ Form::label("status_pernikahan", "Status Pernikahan", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="status_pernikahan" value="{{ $biodatas->biodataCpp->n1Formulir->status_pernikahan }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6" style="display:none">
                      <div class="form-group clearfix{{ $errors->has('status_pernikahan') ? ' has-error' : '' }}">
                        {{ Form::label("tipe_data_id", "Tipe Data", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="tipe_data_id" value="{{ $biodatas->biodataCpp->n1Formulir->tipe_data_id }}" class="form-control" required="required", placeholder= "">
                          </div>
                          @if ($errors->has('status_pernikahan'))
                              <span class="help-block">
                                  <strong>{{ $errors->first('status_pernikahan') }}</strong>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('nama_mantan_pasangan') ? ' has-error' : '' }}">
                        {{ Form::label("nama_mantan_pasangan", "Nama Mantan Istri", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="nama_mantan_pasangan" value="{{ $biodatas->biodataCpp->n1Formulir->nama_mantan_pasangan }}" class="form-control" placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('nomor_surat') ? ' has-error' : '' }}">
                        {{ Form::label("nomor_surat", "nomor_surat Surat", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="nomor_surat" value="{{ $biodatas->biodataCpp->n1Formulir->nomor_surat }}" class="form-control" placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('desa') ? ' has-error' : '' }}">
                        {{ Form::label("desa", "Desa", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="desa" value="{{ $biodatas->biodataCpp->n1Formulir->desa }}" class="form-control" required="required", placeholder= "">
                          </div>
                          @if ($errors->has('desa'))
                              <span class="help-block">
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('kecamatan') ? ' has-error' : '' }}">
                        {{ Form::label("kecamatan", "Kecamatan", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="kecamatan" value="{{ $biodatas->biodataCpp->n1Formulir->kecamatan }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('kabupaten') ? ' has-error' : '' }}">
                        {{ Form::label("kabupaten", "Kabupaten", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="kabupaten" value="{{ $biodatas->biodataCpp->n1Formulir->kabupaten }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('kota_pembuatan') ? ' has-error' : '' }}">
                        {{ Form::label("kota_pembuatan", "Kota", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="kota_pembuatan" value="{{ $biodatas->biodataCpp->n1Formulir->kota_pembuatan }}" class="form-control" placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('tanggal_pembuatan') ? ' has-error' : '' }}">
                        {{ Form::label("tanggal_pembuatan", "Tanggal Pembuatan Formulir", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="tanggal_pembuatan" value="{{ $biodatas->biodataCpp->n1Formulir->tanggal_pembuatan }}" class="form-control" id="datepicker" placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('nama_lurah') ? ' has-error' : '' }}">
                        {{ Form::label("nama_lurah", "Nama Kepala Desa/Lurah", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="nama_lurah" value="{{ $biodatas->biodataCpp->n1Formulir->nama_lurah }}" class="form-control" placeholder= "">
                          </div>
