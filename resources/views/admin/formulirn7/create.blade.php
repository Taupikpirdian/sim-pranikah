...
<div class="content-i">
    <div class="content-box">
      <div class="element-wrapper">
        ...
        {{ Form::open(array('url' => '/n7-formulir/create', 'files' => true, 'method' => 'post')) }}
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('lampiran') ? ' has-error' : '' }}">
                        {{ Form::label("lampiran", "Lampiran", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="lampiran" value="{{ old('lampiran') }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('lembar') ? ' has-error' : '' }}">
                        {{ Form::label("lembar", "Lembar", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="lembar" value="{{ old('lembar') }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('lokasi_pengiriman') ? ' has-error' : '' }}">
                        {{ Form::label("lokasi_pengiriman", "Lokasi Pengiriman", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="lokasi_pengiriman" value="{{ old('lokasi_pengiriman') }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('tanggal_pernikahan') ? ' has-error' : '' }}">
                        {{ Form::label("tanggal_pernikahan", "Tanggal Pernikahan", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="tanggal_pernikahan" value="{{ old('tanggal_pernikahan') }}" class="form-control" id="datepicker" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('jam_pernikahan') ? ' has-error' : '' }}">
                        {{ Form::label("jam_pernikahan", "Jam Pernikahan", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="jam_pernikahan" value="{{ old('jam_pernikahan') }}" class="form-control" placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('mas_kawin') ? ' has-error' : '' }}">
                        {{ Form::label("mas_kawin", "Mas Kawin", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="mas_kawin" value="{{ old('mas_kawin') }}" class="form-control" placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('tempat_pernikahan') ? ' has-error' : '' }}">
                        {{ Form::label("tempat_pernikahan", "Tempat Pernikahan", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="tempat_pernikahan" value="{{ old('tempat_pernikahan') }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('tanggal_terima') ? ' has-error' : '' }}">
                        {{ Form::label("tanggal_terima", "Tanggal Terima", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="tanggal_terima" value="{{ old('tanggal_terima') }}" class="form-control" id="datepicker2" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('penerima') ? ' has-error' : '' }}">
                        {{ Form::label("penerima", "Nama Penerima", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="penerima" value="{{ old('penerima') }}" class="form-control" required="required", placeholder= "">
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group clearfix{{ $errors->has('pemberitahu') ? ' has-error' : '' }}">
                        {{ Form::label("pemberitahu", "Nama Pemberitahu", ['class' => 'col-md-12 control-label']) }}
                          <div class='col-md-12'>
                          <input type="text" name="pemberitahu" value="{{ old('pemberitahu') }}" class="form-control" required="required", placeholder= "">
                          </div>
