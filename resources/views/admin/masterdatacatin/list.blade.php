    ...
    <div class="content-box">
      <div class="element-wrapper">
        <h6 class="element-header">
         	Master Data Pengantin
        </h6>
        <div class="element-box">
          <h5 class="form-header">
            List Master Data Calon Pengantin
          </h5>
          <div class="form-desc">
			   		...
			   		@foreach($catins as $i=>$catin)
			     		<tr>
			         		...
			         		<td> 
								...
								<a href='{{URL::action("AdminController@kelengkapanCatin",array($catin->id))}}' class="btn btn-info btn-crud" style="width: 200px">Surat N~</a>
								@else
								<a href='{{URL::action("AdminController@kelengkapanCatin",array($catin->id))}}' class="btn btn-info btn-crud" style="width: 200px">Edit</a>
								@endif
								<a href='{{URL::action("AdminController@cetakDataCatin",array($catin->id))}}' class="btn btn-info btn-crud" style="width: 200px">Cetak Data</a>
